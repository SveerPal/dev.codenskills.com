            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-info">
                        <figure><a href="<?php echo site_url();?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/footer-logo.png" alt=""></a></figure>
                ...
                <div class="col-md-3">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <li><a href="#">Couple matching cundli</a></li>
                            <li><a href="#">Lucky Vichle Suggestion</a></li>
                            <li><a href="#">Lucky Mobile Nimber</a></li>
                            <li><a href="#">Lucky Name Consultation</a></li>
                            <li><a href="#">Business Consultation</a></li>
                            <li><a href="#">Logo Design</a></li>
                            <li><a href="#">Baby name Correction</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <section class="copy-right-sec">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="copy-wrap">
                        <p>Copyright © <?php echo date('Y')?>. <a href="<?php echo site_url();?>">Jovial Vision </a> All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
