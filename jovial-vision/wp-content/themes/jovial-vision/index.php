...
<section class="bg-img-sec">
    <figure>
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/bg1.webp" alt="<?php echo get_the_title(2);?>">
	</figure>
</section>
            ...
            <div class="col-md-6">
                <div class="about1-img">
                    <figure>
						...
						<?php if( get_field('second_thumbnail',2)){ 
    				
							$image = get_field('second_thumbnail',2);
		?>                        
                         <img src="<?php echo $image['url']; ?>" alt="<?php echo get_the_title(2); ?>">
                ...
                <div class="about1-wrap">
                    <div class="section-title">
                        ...
                        <div class="about1-dis">
                            ...
                            echo substr(wp_strip_all_tags($content), 0, 1000);
                            ?>...</p>
                        </div>


                        <a class="btn-style-1 text-left about-us-btn" href="<?php the_permalink(2) ?>">Read More</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    if ($query->have_posts()):
                        while ($query->have_posts()):
                            $query->the_post();
                            ?>
                            <div class="col-md-4 vide-play-box" onclick="playVideo('yt-<?php echo get_the_id(); ?>','<?php echo get_the_excerpt(); ?>')" url="<?php echo get_the_excerpt(); ?>">
                                
                                    <img id="yt-<?php echo get_the_id(); ?>" src="" />
                                   <figure class="youtube-btn">
									    <img class="youtube-btn-img" src="https://dev.codenskills.com/jovial-vision/wp-content/uploads/2024/09/youtube.png">
								  </figure>
                            </div>
