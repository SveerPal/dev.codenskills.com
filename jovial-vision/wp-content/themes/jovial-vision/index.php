...
<!-- banner section start here -->
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/banner.webp" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/banner1.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7 col-offset-5">
                                    <div class="banner-content">
                                        <!-- <div class="banner-text">
                                            <h2>Jovial<span> Vision</span></h2>
                                            <ul>
                                                <li>Lucky Name Consultation</li>
                                                <li>Business Consultation</li>
                                                <li>Logo Design</li>
                                                <li>Baby name Correction</li>
                                            </ul>
                                            <div class="call-into">
                                                <p><a class="phone main-btn" href="tel+91 0123456789"><span>Call
                                                            :</span>+91 0123456789</a></p>
    ...
    <section class="stats-sec" style="background:url(<?php echo get_template_directory_uri(); ?>/assets/images/bg1.webp) no-repeat center;">
        <div class="container">
                        ...
                        <div class="owl-carousel owl-theme" id="astrology">
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser1.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser2.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser3.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser4.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser5.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser6.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
                            ...
                            <div class="item">
                                <div class="astrology-wrap">
                                    <figure>
                                        <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ser7.png" alt=""> </a>
                                    </figure>
                                    <div class="ser-wrap">
    ...
    <section class="insta-feed-sec" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/bg7.webp) no-repeat center;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                    ...
                    <div class="section-padding">
                        <div class="screenshot_slider owl-carousel">
                            <div class="item">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/story1.webp" alt="" title="">
                                <div class="achv-content text-center">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/story2.webp" alt="" title="">
                                <div class="achv-content text-center">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/story3.webp" alt="" title="">
                                <div class="achv-content text-center">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                </div>
                            </div>
                            <div class="item">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/story4.webp" alt="" title="">
                                <div class="achv-content text-center">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                </div>
                            </div>
                            ...
                            <div class="owl-carousel owl-theme" id="product">
                                <div class="item">
                                    <div class="products">
                                        <div class="al-product-image">
                                            <figure>
                                                <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pro1.png" alt=""> </a>
                                            </figure>
                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="al-product-image">
                                            <figure>
                                                <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pro2.png" alt=""> </a>
                                            </figure>
                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="al-product-image">
                                            <figure>
                                                <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pro3.png" alt=""> </a>
                                            </figure>
                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="al-product-image">
                                            <figure>
                                                <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pro4.png" alt=""> </a>
                                            </figure>
                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="al-product-image">
                                            <figure>
                                                <a href="#"> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pro5.png" alt=""> </a>
                                            </figure>
    ...
    <section class="blog-sec latest-videos-sec" style="background: url(<?php echo get_template_directory_uri(); ?>/assets/images/bg8.webp) no-repeat center;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="blog-wrap">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-img">
                        <figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/contact-img.webp" alt=""></figure>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="blog">
                                <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog1.webp" alt=""></a></figure>
                                <div class="blog-info">
                        ...
                        <div class="col-md-4">
                            <div class="blog">
                                <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog2.webp" alt=""></a></figure>
                                <div class="blog-info">
                        ...
                        <div class="col-md-4">
                            <div class="blog">
                                <figure><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog3.webp" alt=""></a></figure>
                                <div class="blog-info">
